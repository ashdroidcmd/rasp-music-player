    ...
    <div className="h-dvh bg-neutral-950 text-white">
      <div className="p-5 max-w-2xl mx-auto">
        ...
        <div className="space-y-4 text-base leading-relaxed">
          <p>
            <strong>Step 1: Upload MP3 to Dropbox</strong><br />
            Go to <a href="https://www.dropbox.com" className="text-[#1ED760] underline" target="_blank" rel="noreferrer">Dropbox</a> and upload your MP3 file.
          </p>

          <p>
            <strong>Step 2: Copy the Share Link</strong><br />
            After uploading, click “Share” → “Create Link” → “Copy Link”.
          </p>

          <p>
            <strong>Step 3: Convert Link for Direct Play</strong><br />
          ...
          <p>
            <strong>Step 4: Edit <code>data.json</code></strong><br />
            Add a new object like this:
            <pre className="bg-neutral-800 p-3 rounded text-sm overflow-x-auto">
{`{
  "id": 3,
